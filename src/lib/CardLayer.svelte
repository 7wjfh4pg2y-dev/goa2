...
<style>
	...
	.stat6 { position: relative; display: flex; flex-direction: column; align-items: center; gap: 2px; padding: 12px 4px 7px; border-radius: 12px;
		background: rgba(12,18,32,.5); border: 1px solid rgba(255,255,255,.1); }
	...
	.stat6.up .si { opacity: 1; }
	.stat6.up .sv { color: #ffd7ad; } .stat6.up .sv em { color: #ffb774; }
	.stat6.up .slbl { color: #d8a878; }

	.turns { display: flex; align-items: stretch; gap: 10px; }
	.tbox { flex: 1; display: flex; flex-direction: column; gap: 7px; padding: 9px 8px 10px; border-radius: 16px;
		background: rgba(12,18,32,.46); backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,.12);
		border-bottom: 3px solid var(--tint); box-shadow: 0 12px 30px rgba(0,0,0,.4); }
	...
	.cback .pending { position: absolute; left: 50%; bottom: 15%; transform: translateX(-50%); font-size: .54rem; letter-spacing: .1em; text-transform: uppercase; font-weight: 800; white-space: nowrap;
		color: #2a1d12; background: linear-gradient(#efc078, #d89a3e); border: 1px solid rgba(0,0,0,.3); border-radius: 6px; padding: 2px 9px; box-shadow: 0 2px 6px rgba(0,0,0,.5); }
