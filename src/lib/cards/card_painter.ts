...
const baseImageModules = import.meta.glob("./images/*.png", { eager: true, import: "default" }) as Record<string, string>
const cardImageModules = import.meta.glob("./images/cards/*/*.webp", { eager: true, import: "default" }) as Record<string, string>
...
export async function importCardImage(hero: string, card: string) {
	const path = cardImageModules[`./images/cards/${hero}/${card}.webp`]
	if (path == null) {
		return
	}
	const image = new Image()
